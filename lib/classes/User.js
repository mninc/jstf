...
class User {
    ...
    calculateListingSlots() {
        /*
        this calculator is not completely correct - we can't see if you're following the site on twitter,
        and it seems something else increases the number of slots, as the number is usually lower than the
        actual value
         */
        let slots = 70;
        if (this.integrations.groupMember) slots += 15;
